...
<div class="card">
  <div class="card-body">
    ...
    <div class="text-right mb-4">
      <button type="button" class="btn btn-primary" onclick="window.location='{{route("admin.alat.tambah")}}'"> Tambah</button>
    </div>
    <div class="row">
      <div class="col-12">
          ...
          <table id="order-listing" class="table">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td width="14%">
                    <button onclick="window.location='{{route("admin.alat.edit",[$alat->id,$alat->slug])}}'" class="btn btn-warning btn-lg text-white"> <i class="fa fa-pencil"></i> </button>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="" action="{{route('admin.alat.hapus', $alat)}}" method="post">
                          @csrf
